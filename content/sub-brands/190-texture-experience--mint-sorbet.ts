...
const entry: SubBrand = {
    ...
    bannerBg: "#eee8e0",
    theme: "accent-light",
    heroWordmark: "/media/brands/texture-experience/lines/mint-sorbet/hero/wordmark.png",
    ...
    heroLayers: [
      { src: "/media/brands/texture-experience/lines/mint-sorbet/hero/1.png", enterFrom: "right", enterDelay: 0.2, depth: 50,
        width: "min(43vw, 83vh)", aspectRatio: "3772 / 3748", left: "52%", top: "12%",
        mobile: { left: "-17%", top: "-15%", width: "115%" } },
    ],
    showcaseTitle: "/media/brands/texture-experience/lines/mint-sorbet/showcase/title.png",
    ...
    cards: [
      { image: { en: "/media/brands/texture-experience/lines/mint-sorbet/showcase/1.en.png", id: "/media/brands/texture-experience/lines/mint-sorbet/showcase/1.id.png" }, label: { en: "Shampoo Mint Sorbet", id: "Shampoo Mint Sorbet" } },
      { image: { en: "/media/brands/texture-experience/lines/mint-sorbet/showcase/2.en.png", id: "/media/brands/texture-experience/lines/mint-sorbet/showcase/2.id.png" }, label: { en: "Conditioner Mint Sorbet", id: "Conditioner Mint Sorbet" } },
      { image: { en: "/media/brands/texture-experience/lines/mint-sorbet/showcase/3.en.png", id: "/media/brands/texture-experience/lines/mint-sorbet/showcase/3.id.png" }, label: { en: "Creambath Mint Sorbet", id: "Creambath Mint Sorbet" } },
      { image: { en: "/media/brands/texture-experience/lines/mint-sorbet/showcase/4.en.png", id: "/media/brands/texture-experience/lines/mint-sorbet/showcase/4.id.png" }, label: { en: "Hair Perfume Mint Mocktail", id: "Hair Perfume Mint Mocktail" } },
    ],
  };
