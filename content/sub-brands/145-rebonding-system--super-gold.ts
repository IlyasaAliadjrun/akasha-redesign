...
const entry: SubBrand = {
  ...
  bannerBg: "#F2EFE9",
  theme: "dark",
  heroWordmark: "/media/brands/rebonding-system/lines/super-gold/hero/wordmark.png",
  heroWordmarkAspect: "1123 / 283",
  heroWordmarkWidth: "min(21vw, 520px)",
  heroWordmarkMobileWidth: "48vw",
  heroLayers: [
    {
      src: "/media/brands/rebonding-system/lines/super-gold/hero/1.png",
      enterFrom: "right",
      enterDelay: 0.25,
      depth: 44,
  ...
  showcaseTitle: { en: "/media/brands/rebonding-system/lines/super-gold/showcase/title.en.png", id: "/media/brands/rebonding-system/lines/super-gold/showcase/title.id.png" },
