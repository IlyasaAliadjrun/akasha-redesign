...
const entry: SubBrand = {
  ...
  bannerBg: "#826D99",
  theme: "light",
  heroWordmark: "/media/brands/128/lines/advanced-age-repair/hero/wordmark.png",
  heroWordmarkAspect: "2160 / 1415",
  heroWordmarkWidth: "13vw",
  heroWordmarkMobileWidth: "23vw",
  heroLayers: [
    {
      src: "/media/brands/128/lines/advanced-age-repair/hero/1.png",
      enterFrom: "right",
      enterDelay: 0.25,
      depth: 36,
      width: "min(25vw, 63vh)",
  ...
  showcaseTitle: "/media/brands/128/lines/advanced-age-repair/showcase/title.png",
