...
const entry: SubBrand = {
    ...
    heroLayers: [
      ...
      { src: "/media/brands/advisor-rx/lines/strong-hair/hero/2.png", enterFrom: "top", enterDelay: 0.15, depth: 48, width: "min(50vw, 61vh)", aspectRatio: "1 / 1", left: "59%", top: "9%",
        mobile: { left: "12%", top: "-23%", width: "85%" } },
      // 1 — Shampoo (250 mL), tallest, enters from the left.
      { src: "/media/brands/advisor-rx/lines/strong-hair/hero/1.png", enterFrom: "left", enterDelay: 0, depth: 36, width: "min(53vw, 73vh)", aspectRatio: "1 / 1", left: "49%", top: "15.5%",
        mobile: { left: "-20%", top: "-12%", width: "105%" } },
      // 3 — Hair Tonic (100 mL).
      { src: "/media/brands/advisor-rx/lines/strong-hair/hero/3.png", enterFrom: "top", enterDelay: 0.3, depth: 60, width: "min(52.5vw, 71vh)", aspectRatio: "1 / 1", left: "64.5%", top: "12.5%",
        mobile: { left: "29%", top: "-5%", width: "85%" } },
      // 4 — Scalp Serum (40 mL), smallest, enters from the right.
      { src: "/media/brands/advisor-rx/lines/strong-hair/hero/4.png", enterFrom: "right", enterDelay: 0.45, depth: 72, width: "min(27.3vw, 33vh)", aspectRatio: "1491 / 2058", left: "68%", top: "42%",
        mobile: { left: "40%", top: "33%", width: "40%" } },
    ],
    showcaseTitle: { en: "/media/brands/advisor-rx/lines/strong-hair/showcase/title.en.png", id: "/media/brands/advisor-rx/lines/strong-hair/showcase/title.id.png" },
    ...
    cards: [
      { image: { en: "/media/brands/advisor-rx/lines/strong-hair/showcase/1.en.png", id: "/media/brands/advisor-rx/lines/strong-hair/showcase/1.id.png" }, label: { en: "Strong Hair Shampoo", id: "Strong Hair Shampoo" } },
      { image: { en: "/media/brands/advisor-rx/lines/strong-hair/showcase/2.en.png", id: "/media/brands/advisor-rx/lines/strong-hair/showcase/2.id.png" }, label: { en: "Strong Hair Boosting Mask", id: "Strong Hair Masker Penguat" } },
      { image: { en: "/media/brands/advisor-rx/lines/strong-hair/showcase/3.en.png", id: "/media/brands/advisor-rx/lines/strong-hair/showcase/3.id.png" }, label: { en: "Strong Hair Hair Tonic", id: "Strong Hair Tonik Rambut" } },
      { image: { en: "/media/brands/advisor-rx/lines/strong-hair/showcase/4.en.png", id: "/media/brands/advisor-rx/lines/strong-hair/showcase/4.id.png" }, label: { en: "Strong Hair Scalp Serum", id: "Strong Hair Serum Kulit Kepala" } },
    ],
  };
