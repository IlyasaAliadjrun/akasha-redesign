...
const entry: SubBrand = {
    ...
    bannerBg: "#EFEFEF",
    theme: "accent-light",
    heroWordmark: "/media/brands/honey-dew/lines/shampoo/hero/wordmark.png",
    ...
    heroLayers: [
      ...
      { src: "/media/brands/honey-dew/lines/shampoo/hero/1.png", enterFrom: "right", enterDelay: 0.2, depth: 40, width: "min(40.5vw, 47vh)", aspectRatio: "1672 / 2451", left: "63%", top: "17%",
        mobile: { left: "12%", top: "-20%", width: "75%" } },
    ],
    showcaseTitle: { en: "/media/brands/honey-dew/lines/shampoo/showcase/title.en.png", id: "/media/brands/honey-dew/lines/shampoo/showcase/title.id.png" },
