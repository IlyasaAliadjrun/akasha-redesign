...
const entry: SubBrand = {
    ...
    accentHex: "#6B3F1D",
    bannerBg: "#6B3F1D",
    heroWordmark: "/media/brands/barber-daily/lines/body-care/hero/wordmark.png",
    ...
    heroLayers: [
      { src: "/media/brands/barber-daily/lines/body-care/hero/2.png", enterFrom: "right", enterDelay: 0.4, depth: 38,
        width: "min(43vw, 65vh)", aspectRatio: "2647 / 2646", left: "66.5%", top: "7.1%",
        mobile: { right: "-12%", top: "-16%", width: "80%" } },
      { src: "/media/brands/barber-daily/lines/body-care/hero/1.png", enterFrom: "left", enterDelay: 0.2, depth: 60,
    ...
    showcaseTitle: { en: "/media/brands/barber-daily/lines/body-care/showcase/title.en.png", id: "/media/brands/barber-daily/lines/body-care/showcase/title.id.png" },
    ...
    cards: [
      { image: { en: "/media/brands/barber-daily/lines/body-care/showcase/1.en.png", id: "/media/brands/barber-daily/lines/body-care/showcase/1.id.png" }, label: { en: "Antiperspirant", id: "Antiperspirant" } },
      { image: { en: "/media/brands/barber-daily/lines/body-care/showcase/2.en.png", id: "/media/brands/barber-daily/lines/body-care/showcase/2.id.png" }, label: { en: "Perfume", id: "Perfume" } },
    ],
  };
