...
const entry: SubBrand = {
  ...
  theme: "dark",
  heroWordmark:
    "/brand/rebonding-system/gold-edition/hero/wordmark.png",
  heroWordmarkAspect: "1123 / 283",
  heroWordmarkWidth: "min(21vw, 520px)",
  heroWordmarkMobileWidth: "48vw",
  heroLayers: [
    {
      src: "/brand/rebonding-system/gold-edition/hero/1.png",
      enterFrom: "right",
      enterDelay: 0.25,
      depth: 44,
  ...
  showcaseTitle:
    "/brand/rebonding-system/gold-edition/showcase/title.png",
