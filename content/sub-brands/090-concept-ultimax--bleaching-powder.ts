...
const entry: SubBrand = {
    ...
    bannerBg: "#E6EAE4",
    theme: "accent-light",
    heroWordmark: "/media/brands/concept-ultimax/lines/bleaching-powder/hero/wordmark.png",
    heroWordmarkAspect: "2339 / 473",
    heroLayers: [
      { src: "/media/brands/concept-ultimax/lines/bleaching-powder/hero/1.png", enterFrom: "right", enterDelay: 0.2, depth: 44, width: "min(34vw, 58vh)", aspectRatio: "2639 / 3297", left: "62%", top: "16%",
    ...
    showcaseTitle: "/media/brands/concept-ultimax/lines/bleaching-powder/showcase/title.png",
    showcaseTitleAspect: "4661 / 2442",
    featured: { image: { en: "/media/brands/concept-ultimax/lines/bleaching-powder/showcase/1.en.png", id: "/media/brands/concept-ultimax/lines/bleaching-powder/showcase/1.id.png" }, label: { en: "Bleaching Powder — a fast, safe bleaching solution for hair", id: "Bleaching Powder — solusi bleaching cepat dan aman untuk rambut" } },
