...
const entry: SubBrand = {
  ...
  bannerBg: "#AABD7A",
  theme: "light",
  heroWordmark: "/media/brands/128/lines/acne-pro/hero/wordmark.png",
  heroWordmarkAspect: "2160 / 1415",
  heroWordmarkWidth: "13vw",
  heroWordmarkMobileWidth: "23vw",
  heroLayers: [
    {
      src: "/media/brands/128/lines/acne-pro/hero/1.png",
      enterFrom: "right",
      enterDelay: 0.25,
      depth: 36,
      width: "min(25vw, 68vh)",
  ...
  showcaseTitle: { en: "/media/brands/128/lines/acne-pro/showcase/title.en.png", id: "/media/brands/128/lines/acne-pro/showcase/title.id.png" },
  showcaseTitleAspect: "4865 / 3703",
  showcaseTitleOffsetY: "30px",
  showcaseTitleMobileOffsetY: "4px",
  showcaseVariants: [
    { bg: "/media/brands/128/lines/acne-pro/showcase/1.png", bgAspect: "4687 / 2233" },
    { bg: "/media/brands/128/lines/acne-pro/showcase/2.png", bgAspect: "4687 / 2234" },
  ],
