...
const entry: Brand = {
    ...
    heroLayers: [
      ...
      { src: "/brand/honey-dew/hero/2.png", depth: 36, enterFrom: "top", enterDelay: 0, width: "min(19vw, 23vh)", aspectRatio: "1672 / 2451", left: "54.5%", top: "11.5%",
      ...
      { src: "/brand/honey-dew/hero/3.png", depth: 66, enterFrom: "right", enterDelay: 0.3, width: "min(39.7vw, 48vh)", aspectRatio: "3058 / 3865", left: "53.8%", top: "10.2%",
        mobile: { left: "26%", top: "18%", width: "min(80vw, 46vh)" } },
      // Nutriv Serum — front left, smallest, enters from the LEFT (2nd).
      { src: "/brand/honey-dew/hero/1.png", depth: 54, enterFrom: "left", enterDelay: 0.15, width: "min(27vw, 32vh)", aspectRatio: "2278 / 2569", left: "39%", top: "44%",
