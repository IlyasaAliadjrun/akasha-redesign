...
const entry: Brand = {
    ...
    heroLayers: [
      ...
      { src: "/media/brands/vica/hero/1.png", depth: 0, enterFrom: "right", enterDelay: 0.3,
    ...
    heroContent: {
      logo: "/media/brands/vica/hero/wordmark.png",
      logoAspect: "550 / 595",
      logoWidth: "21vw",
      left: "10%",
      offsetY: "1.8vh",
    ...
    hero: false,
    products: [
      { name: "VICA", variant: { en: "220 mL", id: "220 mL" }, image: "/media/brands/vica/product-lineup/vica-220ml.png", imageScale: 0.7 },
      { name: "VICA", variant: { en: "330 mL", id: "330 mL" }, image: "/media/brands/vica/product-lineup/vica-330ml.png", imageScale: 0.8},
      { name: "VICA", variant: { en: "600 mL", id: "600 mL" }, image: "/media/brands/vica/product-lineup/vica-600ml.png", imageScale: 0.9 },
      { name: "VICA", variant: { en: "1010 mL", id: "1010 mL" }, image: "/media/brands/vica/product-lineup/vica-1010ml.png", imageScale: 0.9 },
      { name: "VICA", variant: { en: "1500 mL", id: "1500 mL" }, image: "/media/brands/vica/product-lineup/vica-1500ml.png" },
    ],
    about: [
      { title: { en: "From a spring whose purity has been preserved for over 100 years", id: "Dari mata air yang kemurniannya terjaga lebih dari 100 tahun" }, image: "/media/brands/vica/about/1.png" },
      { title: { en: "Through 0.2-micron filtration technology", id: "Melalui teknologi filtrasi 0,2 micron" }, image: "/media/brands/vica/about/2.png" },
      { title: { en: "Processed with fully automated Krones machinery", id: "Diproses mesin Krones dengan full automation" }, image: "/media/brands/vica/about/3.png" },
    ],
    reasons: [
    ...
    showcase: {
      hero: { en: "/media/brands/vica/showcase/title.en.png", id: "/media/brands/vica/showcase/title.id.png" },
      heroAspect: "1250 / 764",
      ...
      variants: [
        ...
        { bg: "/media/brands/vica/showcase/1-2.png", product: "/media/brands/vica/showcase/1-1.png", bgAspect: "1080 / 465", productAspect: "1 / 1", productHeight: "93%", side: "right", productShiftX: "-15%",
          mobile: { productHeight: "112%", productShiftX: "-5%" } },
        // 330 mL — POCKET FRESH (bottle left, centred)
        { bg: "/media/brands/vica/showcase/2-2.png", product: "/media/brands/vica/showcase/2-1.png", bgAspect: "1080 / 465", productAspect: "1 / 1", productHeight: "90%", side: "left", productShiftX: "25%",
          mobile: { productHeight: "106%", productShiftX: "20%" } },
        // 600 mL — DAILY BUDDY (bottle right, grounded)
        { bg: "/media/brands/vica/showcase/3-2.png", product: "/media/brands/vica/showcase/3-1.png", bgAspect: "1080 / 465", productAspect: "1 / 1", productHeight: "88%", side: "right", productShiftX: "-20%", groundBottom: true,
          mobile: { productHeight: "106%", productShiftX: "-10%" } },
        // 1010 mL — LONGER HYDRATION (bottle left, grounded)
        { bg: "/media/brands/vica/showcase/4-2.png", product: "/media/brands/vica/showcase/4-1.png", bgAspect: "1080 / 465", productAspect: "1 / 1", productHeight: "92%", side: "left", productShiftX: "18%", groundBottom: true,
          mobile: { productHeight: "106%", productShiftX: "15%" } },
        // 1500 mL — ALL-DAY HYDRATION (bottle right, grounded)
        { bg: "/media/brands/vica/showcase/5-2.png", product: "/media/brands/vica/showcase/5-1.png", bgAspect: "1080 / 465", productAspect: "1 / 1", productHeight: "93%", side: "right", productShiftX: "-16%", groundBottom: true,
