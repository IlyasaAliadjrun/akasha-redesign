...
const entry: Brand = {
    ...
    heroImage: "/media/brands/lou/about/3.png",
    ...
    heroLayers: [
      ...
      { src: "/media/brands/lou/hero/2.png", depth: 36, enterFrom: "left", enterDelay: 0, width: "min(26vw, 32vh)", aspectRatio: "2160 / 3840", right: "20%", bottom: "27%",
        mobile: { left: "38%", top: "31%", right: "auto", bottom: "auto", width: "min(30vw, 30vh)" } },
      // Grow More spray — right edge, level with the tube (100 mL).
      { src: "/media/brands/lou/hero/3.png", depth: 54, enterFrom: "right", enterDelay: 0.4, width: "min(34vw, 42vh)", aspectRatio: "2160 / 3109", right: "9.5%", bottom: "16%",
      ...
      { src: "/media/brands/lou/hero/1.png", depth: 72, enterFrom: "top", enterDelay: 0.2, width: "min(38vw, 46vh)", aspectRatio: "2160 / 3311", right: "25%", bottom: "8%",
        mobile: { left: "4%", top: "27.5%", right: "auto", bottom: "auto", width: "min(60vw, 50vh)" } },
    ],
    heroContent: {
      logo: "/media/brands/lou/hero/wordmark.png",
    ...
    hero: false,
    products: [
      { name: "Rest Easy", variant: { en: "Gentle Calming Cream", id: "Krim Penenang Lembut" }, size: { en: "50 mL", id: "50 mL" }, image: "/media/brands/lou/product-lineup/rest-easy-gentle-calming-cream-50ml.png" },
      { name: "Grow More", variant: { en: "Nourishing Hair Lotion", id: "Losion Rambut Penutrisi" }, size: { en: "100 mL", id: "100 mL" }, image: "/media/brands/lou/product-lineup/grow-more-nourishing-hair-lotion-100ml.png" },
      { name: "Don't Cry", variant: { en: "Moisturizing Hair and Body Wash", id: "Sabun Rambut dan Tubuh Pelembap" }, size: { en: "250 mL", id: "250 mL" }, image: "/media/brands/lou/product-lineup/dont-cry-moisturizing-hair-and-body-wash-250ml.png" },
    ],
    about: [
      { title: { en: "Microbiome balance Technology", id: "Microbiome balance Technology" }, image: "/media/brands/lou/about/1.png" },
      { title: { en: "Gentle Formulation", id: "Gentle Formulation" }, image: "/media/brands/lou/about/2.png" },
      { title: { en: "Safe for Newborns", id: "Aman untuk Bayi 0+" }, image: "/media/brands/lou/about/3.png" },
    ],
    ...
    showcase: {
      hero: { en: "/media/brands/lou/showcase/title.en.png", id: "/media/brands/lou/showcase/title.id.png" },
      ...
      variants: [
        ...
        { bg: { en: "/media/brands/lou/showcase/1-2.en.png", id: "/media/brands/lou/showcase/1-2.id.png" }, product: "/media/brands/lou/showcase/1-1.png",
        ...
        { bg: { en: "/media/brands/lou/showcase/2-2.en.png", id: "/media/brands/lou/showcase/2-2.id.png" }, product: "/media/brands/lou/showcase/2-1.png",
        ...
        { bg: { en: "/media/brands/lou/showcase/3-2.en.png", id: "/media/brands/lou/showcase/3-2.id.png" }, product: "/media/brands/lou/showcase/3-1.png",
