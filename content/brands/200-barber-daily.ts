...
const entry: Brand = {
    ...
    tagline: "Menuju Ganteng & Wangi.",
    // Becomes the BrandIntro headline (it appends its own period, so none here;
    // no ". " inside so it stays one block).
    description:
      "Solusi perawatan pria terbaik yang siap nemenin kalian buat nemuin produk perawatan diri khusus untuk pria Indonesia",
    ...
    heroContent: {
      ...
      logoWidth: "24vw",
      maxWidth: "34vw",
      tagline: "Perawatan Terbaik, Diformulasikan untuk Pria.",
      ctaText: "Learn more",
      ctaHref: "#about",
      left: "8%",
      offsetY: "2vh",
    ...
    products: [
      { name: "Face Wash", variant: "Bright Radiance", image: "/brand/barber-daily/product-lineup/PRODUCTS-08.png" },
      { name: "Face Wash", variant: "Acne Care Oil-Control", image: "/brand/barber-daily/product-lineup/PRODUCTS-01.png" },
      { name: "Face Wash", variant: "Ultra Sensitive", image: "/brand/barber-daily/product-lineup/PRODUCTS-09.png" },
      { name: "Moisturizer", variant: "Bright Radiance", size: "30 mL", image: "/brand/barber-daily/product-lineup/PRODUCTS-03.png", imageScale: 1.15 },
      { name: "Moisturizer", variant: "Bright Radiance", size: "50 mL", image: "/brand/barber-daily/product-lineup/PRODUCTS-04.png" },
      { name: "Moisturizer", variant: "Acne Care Oil-Control", size: "30 mL", image: "/brand/barber-daily/product-lineup/PRODUCTS-05.png", imageScale: 1.15 },
      { name: "Serum", variant: "Bright Radiance", size: "40 mL", image: "/brand/barber-daily/product-lineup/PRODUCTS-06.png", imageScale: 1.1 },
      { name: "Spot Gel", variant: "Acne Care Oil-Control", size: "25 mL", image: "/brand/barber-daily/product-lineup/PRODUCTS-02.png" },
      { name: "Shampoo", variant: "Dandruff & Oil-Control", image: "/brand/barber-daily/product-lineup/PRODUCTS-11.png" },
      { name: "4in1", variant: "Shampoo, Conditioner, Body Wash, Face Wash", image: "/brand/barber-daily/product-lineup/PRODUCTS-19.png" },
      { name: "Hair Tonic", variant: "2in1 Anti-Dandruff & Anti-Hairfall", image: "/brand/barber-daily/product-lineup/PRODUCTS-12.png" },
      { name: "Styling Gel", variant: "Wet-Look Finish", image: "/brand/barber-daily/product-lineup/PRODUCTS-14.png" },
      { name: "Styling Gel", variant: "Wet-Look Finish · Hold Factor 3", image: "/brand/barber-daily/product-lineup/PRODUCTS-13.png", imageScale: 1.7 },
      { name: "Pomade", variant: "Strong Compound · Semi-Glossy Finish", image: "/brand/barber-daily/product-lineup/PRODUCTS-16.png", imageScale: 1.7 },
      { name: "Pomade", variant: "Strong Compound · Hold Factor 4", image: "/brand/barber-daily/product-lineup/PRODUCTS-15.png", imageScale: 1.7 },
      { name: "Pomade", variant: "Medium Compound · Glossy Finish", image: "/brand/barber-daily/product-lineup/PRODUCTS-18.png", imageScale: 1.7 },
      { name: "Pomade", variant: "Medium Compound · Hold Factor 3", image: "/brand/barber-daily/product-lineup/PRODUCTS-17.png", imageScale: 1.7 },
      { name: "Deodorant", variant: "Antiperspirant Power Shield", image: "/brand/barber-daily/product-lineup/PRODUCTS-10.png", imageScale: 1.2 },
      { name: "Deodorant", variant: "Antiperspirant Comfort Shield", image: "/brand/barber-daily/product-lineup/PRODUCTS-07.png", imageScale: 1.25 },
      { name: "Extrait de Parfum", variant: "Pour D'Glass", image: "/brand/barber-daily/product-lineup/PRODUCTS-23.png" },
      { name: "Extrait de Parfum", variant: "Blossom at Dusk", image: "/brand/barber-daily/product-lineup/PRODUCTS-24.png" },
      { name: "Extrait de Parfum", variant: "Lost in Motion", image: "/brand/barber-daily/product-lineup/PRODUCTS-21.png" },
      { name: "Extrait de Parfum", variant: "Own the Night", image: "/brand/barber-daily/product-lineup/PRODUCTS-22.png" },
      { name: "Razor", variant: "6 Blades", image: "/brand/barber-daily/product-lineup/PRODUCTS-20.png" },
    ],
    about: [
      { title: "Formula pH Rendah", image: "/brand/barber-daily/about/1.png" },
      { title: "Formula Lembut", image: "/brand/barber-daily/about/2.png" },
    ],
